...
namespace CluedIn.Crawling.GetOrganized.Core
{
    public class GetOrganizedConstants
    {
        ...
        public const string CrawlerDescription = "GetOrganized is a ... to be completed ...";
        ...
        // src\GetOrganized.Provider\Resources\cluedin.png
        ...
        public const string CodeOrigin = "GetOrganized";
        public const string ProviderRootCodeValue = "GetOrganized";
        public const string CrawlerName = "GetOrganizedCrawler";
        public const string CrawlerComponentName = "GetOrganizedCrawler";
        public static readonly Guid ProviderId = Guid.Parse("b4df3923-8b0b-43d1-9b1d-e26202e25178");
        public const string ProviderName = "GetOrganized";
