...
{
    public class GetOrganized_Command_MeshProcessor : BaseMeshProcessor
    {
        public GetOrganized_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          GetOrganizedConstants.ProviderId;
