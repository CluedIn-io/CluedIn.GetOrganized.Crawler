...
{
    public class DataIngestion : IClassFixture<GetOrganizedTestFixture>
    {
        private readonly GetOrganizedTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(GetOrganizedTestFixture fixture, ITestOutputHelper output)
        {
